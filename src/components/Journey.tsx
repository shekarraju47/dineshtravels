  ...
  return (
    <section className="flex overflow-hidden flex-col justify-center px-32 py-24 bg-white max-md:px-5">
      <div className="flex flex-wrap gap-0.5 justify-center items-center px-12 w-full max-md:px-5 max-md:max-w-full">
        <JourneyContent />
        <div className="flex flex-col flex-1 shrink items-start self-stretch px-20 pt-9 pb-3.5 my-auto basis-0 min-w-60 max-md:pl-5 max-md:max-w-full">
          <img
            ...
            className="object-contain w-full rounded-xl aspect-[0.72] max-md:max-w-full"
          />
        </div>
      </div>
