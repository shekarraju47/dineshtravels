...
const AboutSection: React.FC = () => {
  return (
    <section className="flex gap-20 items-center p-20 bg-stone-50 max-md:flex-col max-md:px-10 max-sm:px-5">
      <div className="flex-1">
        <img
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/5d2a00ebb5cd2877654759e24f12e327a6602405"
          alt="Experience Travel"
          className="w-full h-[590px] rounded-[12px] object-cover"
        />
      </div>
